#+TITLE: p3nguin-kun's Emacs Config
#+AUTHOR: p3nguin-kun
...
(use-package dashboard
  ...
  (setq dashboard-startup-banner "~/.config/emacs/images/penguin.png")  ;; use custom image as banner
  (setq dashboard-center-content t) ;; set to 't' for centered content
  (setq dashboard-items nil)
  (setq dashboard-show-shortcuts nil)
  (setq dashboard-set-footer nil)
  (setq dashboard-banner-logo-title "Welcome to p3nguin-kun's emacs config")
  :config
